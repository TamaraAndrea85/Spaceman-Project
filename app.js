 // Array of words
const words = ['jupiter', 'stars', 'astroid', 'black-hole', 'satilite', 'orbit', 'universe', 'umbra', 'lunar', 'space=station', 'astronomy', 'super-nova', 'nebula', 'dark-matter', 'celestial-body']
...
//     // context = littleMan.getContext('2d');
//     context.beginPath();
